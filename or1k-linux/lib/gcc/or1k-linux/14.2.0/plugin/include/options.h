...
enum opt_code
{
  ...
  OPT_list = 1954,                           /* -list */
  OPT_mbionic = 1955,                        /* -mbionic */
  OPT_mcmodel_ = 1956,                       /* -mcmodel= */
  OPT_mcmov = 1957,                          /* -mcmov */
  OPT_mdouble_float = 1958,                  /* -mdouble-float */
  OPT_mglibc = 1959,                         /* -mglibc */
  OPT_mhard_div = 1960,                      /* -mhard-div */
  OPT_mhard_float = 1961,                    /* -mhard-float */
  OPT_mhard_mul = 1962,                      /* -mhard-mul */
  OPT_mmusl = 1963,                          /* -mmusl */
  OPT_mror = 1964,                           /* -mror */
  OPT_mrori = 1965,                          /* -mrori */
  OPT_msext = 1966,                          /* -msext */
  OPT_msfimm = 1967,                         /* -msfimm */
  OPT_mshftimm = 1968,                       /* -mshftimm */
  OPT_msoft_div = 1969,                      /* -msoft-div */
  OPT_msoft_float = 1970,                    /* -msoft-float */
  OPT_msoft_mul = 1971,                      /* -msoft-mul */
  OPT_muclibc = 1972,                        /* -muclibc */
  OPT_munordered_float = 1973,               /* -munordered-float */
  OPT_n = 1974,                              /* -n */
  OPT_name_sort = 1975,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1976,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1977,              /* -no-integrated-cpp */
  OPT_no_pie = 1978,                         /* -no-pie */
  OPT_nocpp = 1979,                          /* -nocpp */
  OPT_nodefaultlibs = 1980,                  /* -nodefaultlibs */
  OPT_nolibc = 1981,                         /* -nolibc */
  OPT_nophoboslib = 1982,                    /* -nophoboslib */
  OPT_nostartfiles = 1983,                   /* -nostartfiles */
  OPT_nostdinc = 1984,                       /* -nostdinc */
  OPT_nostdinc__ = 1985,                     /* -nostdinc++ */
  OPT_nostdlib = 1986,                       /* -nostdlib */
  OPT_nostdlib__ = 1987,                     /* -nostdlib++ */
  OPT_o = 1988,                              /* -o */
  OPT_objects = 1989,                        /* -objects */
  OPT_p = 1990,                              /* -p */
  OPT_pass_exit_codes = 1991,                /* -pass-exit-codes */
  /* OPT_pedantic = 1992, */                 /* -pedantic */
  OPT_pedantic_errors = 1993,                /* -pedantic-errors */
  OPT_pg = 1994,                             /* -pg */
  OPT_pie = 1995,                            /* -pie */
  OPT_pipe = 1996,                           /* -pipe */
  OPT_posix = 1997,                          /* -posix */
  ...
  OPT_profile = 2010,                        /* -profile */
  OPT_pthread = 2011,                        /* -pthread */
  OPT_quiet = 2012,                          /* -quiet */
  OPT_r = 2013,                              /* -r */
  OPT_rdynamic = 2014,                       /* -rdynamic */
